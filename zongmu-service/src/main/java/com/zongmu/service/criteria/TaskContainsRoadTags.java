...
public class TaskContainsRoadTags implements Filter {

	private List<Long> tagIds = new ArrayList<>();

	public TaskContainsRoadTags(String tags) {
...
//			subQuery.where(subRoot.get("roadTagId").as(Long.class).in(tagIds));
//			return root.get("taskId").as(Long.class).in(subQuery);
			
			return root.get("roadTagId").as(Long.class).in(tagIds);
		}
